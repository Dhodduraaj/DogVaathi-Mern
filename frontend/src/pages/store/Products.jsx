  ...
  return (
    <div className="w-full space-y-6">
      <header className="text-center">
        ...
        <p className="mt-1 max-w-2xl mx-auto text-sm text-[#333333] dark:text-slate-300">
      ...
      <div className="rounded-xl border border-cream-100 bg-cream-100/80 p-4 dark:border-slate-800 dark:bg-slate-900/40">
        ...
        >
          <div className="space-y-1">
            <label className="flex items-center gap-1.5 font-medium text-[#333333] dark:text-slate-300">
